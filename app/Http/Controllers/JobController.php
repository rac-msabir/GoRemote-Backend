   ...
   public function index(Request $request)
    {
        try {
            ...
            $query = Job::query()
                ->with(['descriptions']) // 👈 eager-load descriptions for grouping
                ->select([
                    'jobs.*',
            ...
            /** ----------------- Filters ----------------- */
            // keep your filters code unchanged ...
            ...
            // Benefits for all jobs in ONE query
            ...
            $data = collect($paginator->items())->map(function ($row) use ($appByJob, $savedByJob, $benefitsByJob) {
                ...
                $descriptions = collect($row->descriptions)->groupBy('type')->map(function ($items) {
                ...
                return [
                    ...
                    'descriptions'    => $descriptions, // 👈 dynamic, grouped by type
                    'benefits'        => $benef,
